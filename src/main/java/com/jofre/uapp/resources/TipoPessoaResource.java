...
public class TipoPessoaResource {
	...
	public ResponseEntity<Void> insert(@RequestBody TipoPessoa obj){			// A anotation @RequestBody converte p Jsom em objeto
	...
	public ResponseEntity<Void> update(@RequestBody TipoPessoa obj, @PathVariable Integer id){
		obj.setId(id);
