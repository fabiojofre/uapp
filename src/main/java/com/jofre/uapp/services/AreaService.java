...
public class AreaService {
	...
	public Area FromDTO(AreaDTO objDTO) {	// Converte um domain num dto
		return new Area(objDTO.getId(), objDTO.getArea(), null);
	}
	
	public Area FromDTO(AreaNewDTO objDTO) {
		Setor setor = new Setor(objDTO.getId(),null,null);
		return new Area(null, objDTO.getArea(), setor);
	}
